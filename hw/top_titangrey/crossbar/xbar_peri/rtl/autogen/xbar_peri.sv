...
module xbar_peri (
  ...
  assign tl_uart1_o = tl_s1n_19_ds_h2d[1];
  assign tl_s1n_19_ds_d2h[1] = tl_uart1_i;

  assign tl_uart2_o = tl_s1n_19_ds_h2d[2];
  assign tl_s1n_19_ds_d2h[2] = tl_uart2_i;

  assign tl_uart3_o = tl_s1n_19_ds_h2d[3];
  assign tl_s1n_19_ds_d2h[3] = tl_uart3_i;

  assign tl_gpio_o = tl_s1n_19_ds_h2d[4];
  assign tl_s1n_19_ds_d2h[4] = tl_gpio_i;

  assign tl_spi_device_o = tl_s1n_19_ds_h2d[5];
  assign tl_s1n_19_ds_d2h[5] = tl_spi_device_i;

  assign tl_rv_timer_o = tl_s1n_19_ds_h2d[6];
  assign tl_s1n_19_ds_d2h[6] = tl_rv_timer_i;

  assign tl_pwrmgr_aon_o = tl_s1n_19_ds_h2d[7];
  assign tl_s1n_19_ds_d2h[7] = tl_pwrmgr_aon_i;

  assign tl_rstmgr_aon_o = tl_s1n_19_ds_h2d[8];
  assign tl_s1n_19_ds_d2h[8] = tl_rstmgr_aon_i;

  assign tl_clkmgr_aon_o = tl_s1n_19_ds_h2d[9];
  assign tl_s1n_19_ds_d2h[9] = tl_clkmgr_aon_i;

  assign tl_otp_ctrl__core_o = tl_s1n_19_ds_h2d[10];
  assign tl_s1n_19_ds_d2h[10] = tl_otp_ctrl__core_i;

  assign tl_otp_ctrl__prim_o = tl_s1n_19_ds_h2d[11];
  assign tl_s1n_19_ds_d2h[11] = tl_otp_ctrl__prim_i;

  assign tl_lc_ctrl_o = tl_s1n_19_ds_h2d[12];
  assign tl_s1n_19_ds_d2h[12] = tl_lc_ctrl_i;

  assign tl_alert_handler_o = tl_s1n_19_ds_h2d[13];
  assign tl_s1n_19_ds_d2h[13] = tl_alert_handler_i;
  ...
  assign tl_sysrst_ctrl_aon_o = tl_s1n_19_ds_h2d[17];
  assign tl_s1n_19_ds_d2h[17] = tl_sysrst_ctrl_aon_i;
