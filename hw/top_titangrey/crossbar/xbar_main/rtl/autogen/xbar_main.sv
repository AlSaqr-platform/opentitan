...
module xbar_main (
  ...
  assign tl_alsaqr_o = tl_s1n_31_ds_h2d[3];
  assign tl_s1n_31_ds_d2h[3] = tl_alsaqr_i;

  assign tl_sm1_33_us_h2d[0] = tl_s1n_31_ds_h2d[4];
  assign tl_s1n_31_ds_d2h[4] = tl_sm1_33_us_d2h[0];

  assign tl_sm1_29_us_h2d[1] = tl_s1n_31_ds_h2d[5];
  assign tl_s1n_31_ds_d2h[5] = tl_sm1_29_us_d2h[1];

  assign tl_sm1_35_us_h2d[0] = tl_s1n_31_ds_h2d[6];
  assign tl_s1n_31_ds_d2h[6] = tl_sm1_35_us_d2h[0];

  assign tl_sm1_36_us_h2d[0] = tl_s1n_31_ds_h2d[7];
  assign tl_s1n_31_ds_d2h[7] = tl_sm1_36_us_d2h[0];

  assign tl_sm1_37_us_h2d[0] = tl_s1n_31_ds_h2d[8];
  assign tl_s1n_31_ds_d2h[8] = tl_sm1_37_us_d2h[0];

  assign tl_sm1_38_us_h2d[0] = tl_s1n_31_ds_h2d[9];
  assign tl_s1n_31_ds_d2h[9] = tl_sm1_38_us_d2h[0];

  assign tl_sm1_30_us_h2d[1] = tl_s1n_31_ds_h2d[10];
  assign tl_s1n_31_ds_d2h[10] = tl_sm1_30_us_d2h[1];

  assign tl_sm1_39_us_h2d[0] = tl_s1n_31_ds_h2d[11];
  assign tl_s1n_31_ds_d2h[11] = tl_sm1_39_us_d2h[0];

  assign tl_sm1_40_us_h2d[0] = tl_s1n_31_ds_h2d[12];
  assign tl_s1n_31_ds_d2h[12] = tl_sm1_40_us_d2h[0];

  assign tl_sm1_41_us_h2d[0] = tl_s1n_31_ds_h2d[13];
  assign tl_s1n_31_ds_d2h[13] = tl_sm1_41_us_d2h[0];

  assign tl_sm1_42_us_h2d[0] = tl_s1n_31_ds_h2d[14];
  assign tl_s1n_31_ds_d2h[14] = tl_sm1_42_us_d2h[0];

  assign tl_sm1_43_us_h2d[0] = tl_s1n_31_ds_h2d[15];
  assign tl_s1n_31_ds_d2h[15] = tl_sm1_43_us_d2h[0];

  assign tl_sm1_44_us_h2d[0] = tl_s1n_31_ds_h2d[16];
  assign tl_s1n_31_ds_d2h[16] = tl_sm1_44_us_d2h[0];

  assign tl_sm1_45_us_h2d[0] = tl_s1n_31_ds_h2d[17];
  assign tl_s1n_31_ds_d2h[17] = tl_sm1_45_us_d2h[0];

  assign tl_sm1_46_us_h2d[0] = tl_s1n_31_ds_h2d[18];
  assign tl_s1n_31_ds_d2h[18] = tl_sm1_46_us_d2h[0];

  assign tl_sm1_47_us_h2d[0] = tl_s1n_31_ds_h2d[19];
  assign tl_s1n_31_ds_d2h[19] = tl_sm1_47_us_d2h[0];

  assign tl_sm1_48_us_h2d[0] = tl_s1n_31_ds_h2d[20];
  assign tl_s1n_31_ds_d2h[20] = tl_sm1_48_us_d2h[0];

  assign tl_sm1_49_us_h2d[0] = tl_s1n_31_ds_h2d[21];
  assign tl_s1n_31_ds_d2h[21] = tl_sm1_49_us_d2h[0];

  assign tl_sm1_50_us_h2d[0] = tl_s1n_31_ds_h2d[22];
  assign tl_s1n_31_ds_d2h[22] = tl_sm1_50_us_d2h[0];

  assign tl_sm1_33_us_h2d[1] = tl_s1n_51_ds_h2d[0];
  assign tl_s1n_51_ds_d2h[0] = tl_sm1_33_us_d2h[1];

  assign tl_sm1_27_us_h2d[2] = tl_s1n_51_ds_h2d[1];
  assign tl_s1n_51_ds_d2h[1] = tl_sm1_27_us_d2h[2];

  assign tl_sm1_32_us_h2d[1] = tl_s1n_51_ds_h2d[2];
  assign tl_s1n_51_ds_d2h[2] = tl_sm1_32_us_d2h[1];

  assign tl_sm1_35_us_h2d[1] = tl_s1n_51_ds_h2d[3];
  assign tl_s1n_51_ds_d2h[3] = tl_sm1_35_us_d2h[1];

  assign tl_sm1_36_us_h2d[1] = tl_s1n_51_ds_h2d[4];
  assign tl_s1n_51_ds_d2h[4] = tl_sm1_36_us_d2h[1];

  assign tl_sm1_37_us_h2d[1] = tl_s1n_51_ds_h2d[5];
  assign tl_s1n_51_ds_d2h[5] = tl_sm1_37_us_d2h[1];

  assign tl_sm1_38_us_h2d[1] = tl_s1n_51_ds_h2d[6];
  assign tl_s1n_51_ds_d2h[6] = tl_sm1_38_us_d2h[1];

  assign tl_sm1_30_us_h2d[2] = tl_s1n_51_ds_h2d[7];
  assign tl_s1n_51_ds_d2h[7] = tl_sm1_30_us_d2h[2];

  assign tl_sm1_44_us_h2d[1] = tl_s1n_51_ds_h2d[8];
  assign tl_s1n_51_ds_d2h[8] = tl_sm1_44_us_d2h[1];

  assign tl_sm1_48_us_h2d[1] = tl_s1n_51_ds_h2d[9];
  assign tl_s1n_51_ds_d2h[9] = tl_sm1_48_us_d2h[1];

  assign tl_sm1_39_us_h2d[1] = tl_s1n_51_ds_h2d[10];
  assign tl_s1n_51_ds_d2h[10] = tl_sm1_39_us_d2h[1];

  assign tl_sm1_40_us_h2d[1] = tl_s1n_51_ds_h2d[11];
  assign tl_s1n_51_ds_d2h[11] = tl_sm1_40_us_d2h[1];

  assign tl_sm1_41_us_h2d[1] = tl_s1n_51_ds_h2d[12];
  assign tl_s1n_51_ds_d2h[12] = tl_sm1_41_us_d2h[1];

  assign tl_sm1_42_us_h2d[1] = tl_s1n_51_ds_h2d[13];
  assign tl_s1n_51_ds_d2h[13] = tl_sm1_42_us_d2h[1];

  assign tl_sm1_43_us_h2d[1] = tl_s1n_51_ds_h2d[14];
  assign tl_s1n_51_ds_d2h[14] = tl_sm1_43_us_d2h[1];
  ...
  assign tl_sm1_50_us_h2d[1] = tl_s1n_51_ds_h2d[18];
  assign tl_s1n_51_ds_d2h[18] = tl_sm1_50_us_d2h[1];

  assign tl_sm1_49_us_h2d[1] = tl_s1n_51_ds_h2d[19];
  assign tl_s1n_51_ds_d2h[19] = tl_sm1_49_us_d2h[1];

  assign tl_sm1_29_us_h2d[2] = tl_s1n_51_ds_h2d[20];
  assign tl_s1n_51_ds_d2h[20] = tl_sm1_29_us_d2h[2];
  ...
  assign tl_spi_host0_o = tl_sm1_36_ds_h2d;
  assign tl_sm1_36_ds_d2h = tl_spi_host0_i;

  assign tl_flash_ctrl__core_o = tl_sm1_37_ds_h2d;
  assign tl_sm1_37_ds_d2h = tl_flash_ctrl__core_i;

  assign tl_flash_ctrl__prim_o = tl_sm1_38_ds_h2d;
  assign tl_sm1_38_ds_d2h = tl_flash_ctrl__prim_i;

  assign tl_aes_o = tl_sm1_39_ds_h2d;
  assign tl_sm1_39_ds_d2h = tl_aes_i;

  assign tl_entropy_src_o = tl_sm1_40_ds_h2d;
  assign tl_sm1_40_ds_d2h = tl_entropy_src_i;

  assign tl_csrng_o = tl_sm1_41_ds_h2d;
  assign tl_sm1_41_ds_d2h = tl_csrng_i;

  assign tl_edn0_o = tl_sm1_42_ds_h2d;
  assign tl_sm1_42_ds_d2h = tl_edn0_i;

  assign tl_edn1_o = tl_sm1_43_ds_h2d;
  assign tl_sm1_43_ds_d2h = tl_edn1_i;

  assign tl_hmac_o = tl_sm1_44_ds_h2d;
  assign tl_sm1_44_ds_d2h = tl_hmac_i;

  assign tl_rv_plic_o = tl_sm1_45_ds_h2d;
  assign tl_sm1_45_ds_d2h = tl_rv_plic_i;

  assign tl_otbn_o = tl_sm1_46_ds_h2d;
  assign tl_sm1_46_ds_d2h = tl_otbn_i;
