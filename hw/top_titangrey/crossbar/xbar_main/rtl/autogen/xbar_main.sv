...
module xbar_main (
  ...
  tl_h2d_t tl_s1n_54_ds_h2d [21];
  tl_d2h_t tl_s1n_54_ds_d2h [21];
  ...
  assign tl_instr_mem_o = tl_s1n_29_ds_h2d[4];
  assign tl_s1n_29_ds_d2h[4] = tl_instr_mem_i;
  ...
  assign tl_sim_ctrl_o = tl_s1n_34_ds_h2d[3];
  assign tl_s1n_34_ds_d2h[3] = tl_sim_ctrl_i;

  assign tl_ram_2p_o = tl_s1n_34_ds_h2d[4];
  assign tl_s1n_34_ds_d2h[4] = tl_ram_2p_i;

  assign tl_alsaqr_o = tl_s1n_34_ds_h2d[5];
  assign tl_s1n_34_ds_d2h[5] = tl_alsaqr_i;

  assign tl_sm1_36_us_h2d[0] = tl_s1n_34_ds_h2d[6];
  assign tl_s1n_34_ds_d2h[6] = tl_sm1_36_us_d2h[0];

  assign tl_sm1_32_us_h2d[1] = tl_s1n_34_ds_h2d[7];
  assign tl_s1n_34_ds_d2h[7] = tl_sm1_32_us_d2h[1];

  assign tl_sm1_38_us_h2d[0] = tl_s1n_34_ds_h2d[8];
  assign tl_s1n_34_ds_d2h[8] = tl_sm1_38_us_d2h[0];

  assign tl_sm1_39_us_h2d[0] = tl_s1n_34_ds_h2d[9];
  assign tl_s1n_34_ds_d2h[9] = tl_sm1_39_us_d2h[0];

  assign tl_sm1_40_us_h2d[0] = tl_s1n_34_ds_h2d[10];
  assign tl_s1n_34_ds_d2h[10] = tl_sm1_40_us_d2h[0];

  assign tl_sm1_41_us_h2d[0] = tl_s1n_34_ds_h2d[11];
  assign tl_s1n_34_ds_d2h[11] = tl_sm1_41_us_d2h[0];

  assign tl_sm1_33_us_h2d[1] = tl_s1n_34_ds_h2d[12];
  assign tl_s1n_34_ds_d2h[12] = tl_sm1_33_us_d2h[1];

  assign tl_sm1_42_us_h2d[0] = tl_s1n_34_ds_h2d[13];
  assign tl_s1n_34_ds_d2h[13] = tl_sm1_42_us_d2h[0];

  assign tl_sm1_43_us_h2d[0] = tl_s1n_34_ds_h2d[14];
  assign tl_s1n_34_ds_d2h[14] = tl_sm1_43_us_d2h[0];

  assign tl_sm1_44_us_h2d[0] = tl_s1n_34_ds_h2d[15];
  assign tl_s1n_34_ds_d2h[15] = tl_sm1_44_us_d2h[0];

  assign tl_sm1_45_us_h2d[0] = tl_s1n_34_ds_h2d[16];
  assign tl_s1n_34_ds_d2h[16] = tl_sm1_45_us_d2h[0];

  assign tl_sm1_46_us_h2d[0] = tl_s1n_34_ds_h2d[17];
  assign tl_s1n_34_ds_d2h[17] = tl_sm1_46_us_d2h[0];

  assign tl_sm1_47_us_h2d[0] = tl_s1n_34_ds_h2d[18];
  assign tl_s1n_34_ds_d2h[18] = tl_sm1_47_us_d2h[0];

  assign tl_sm1_48_us_h2d[0] = tl_s1n_34_ds_h2d[19];
  assign tl_s1n_34_ds_d2h[19] = tl_sm1_48_us_d2h[0];

  assign tl_sm1_49_us_h2d[0] = tl_s1n_34_ds_h2d[20];
  assign tl_s1n_34_ds_d2h[20] = tl_sm1_49_us_d2h[0];

  assign tl_sm1_50_us_h2d[0] = tl_s1n_34_ds_h2d[21];
  assign tl_s1n_34_ds_d2h[21] = tl_sm1_50_us_d2h[0];

  assign tl_sm1_51_us_h2d[0] = tl_s1n_34_ds_h2d[22];
  assign tl_s1n_34_ds_d2h[22] = tl_sm1_51_us_d2h[0];

  assign tl_sm1_52_us_h2d[0] = tl_s1n_34_ds_h2d[23];
  assign tl_s1n_34_ds_d2h[23] = tl_sm1_52_us_d2h[0];

  assign tl_sm1_53_us_h2d[0] = tl_s1n_34_ds_h2d[24];
  assign tl_s1n_34_ds_d2h[24] = tl_sm1_53_us_d2h[0];

  assign tl_sm1_36_us_h2d[1] = tl_s1n_54_ds_h2d[0];
  assign tl_s1n_54_ds_d2h[0] = tl_sm1_36_us_d2h[1];

  assign tl_sm1_30_us_h2d[2] = tl_s1n_54_ds_h2d[1];
  assign tl_s1n_54_ds_d2h[1] = tl_sm1_30_us_d2h[2];

  assign tl_sm1_35_us_h2d[1] = tl_s1n_54_ds_h2d[2];
  assign tl_s1n_54_ds_d2h[2] = tl_sm1_35_us_d2h[1];

  assign tl_sm1_38_us_h2d[1] = tl_s1n_54_ds_h2d[3];
  assign tl_s1n_54_ds_d2h[3] = tl_sm1_38_us_d2h[1];

  assign tl_sm1_39_us_h2d[1] = tl_s1n_54_ds_h2d[4];
  assign tl_s1n_54_ds_d2h[4] = tl_sm1_39_us_d2h[1];

  assign tl_sm1_40_us_h2d[1] = tl_s1n_54_ds_h2d[5];
  assign tl_s1n_54_ds_d2h[5] = tl_sm1_40_us_d2h[1];

  assign tl_sm1_41_us_h2d[1] = tl_s1n_54_ds_h2d[6];
  assign tl_s1n_54_ds_d2h[6] = tl_sm1_41_us_d2h[1];

  assign tl_sm1_33_us_h2d[2] = tl_s1n_54_ds_h2d[7];
  assign tl_s1n_54_ds_d2h[7] = tl_sm1_33_us_d2h[2];

  assign tl_sm1_47_us_h2d[1] = tl_s1n_54_ds_h2d[8];
  assign tl_s1n_54_ds_d2h[8] = tl_sm1_47_us_d2h[1];

  assign tl_sm1_51_us_h2d[1] = tl_s1n_54_ds_h2d[9];
  assign tl_s1n_54_ds_d2h[9] = tl_sm1_51_us_d2h[1];

  assign tl_sm1_42_us_h2d[1] = tl_s1n_54_ds_h2d[10];
  assign tl_s1n_54_ds_d2h[10] = tl_sm1_42_us_d2h[1];

  assign tl_sm1_43_us_h2d[1] = tl_s1n_54_ds_h2d[11];
  assign tl_s1n_54_ds_d2h[11] = tl_sm1_43_us_d2h[1];

  assign tl_sm1_44_us_h2d[1] = tl_s1n_54_ds_h2d[12];
  assign tl_s1n_54_ds_d2h[12] = tl_sm1_44_us_d2h[1];

  assign tl_sm1_45_us_h2d[1] = tl_s1n_54_ds_h2d[13];
  assign tl_s1n_54_ds_d2h[13] = tl_sm1_45_us_d2h[1];

  assign tl_sm1_46_us_h2d[1] = tl_s1n_54_ds_h2d[14];
  assign tl_s1n_54_ds_d2h[14] = tl_sm1_46_us_d2h[1];

  assign tl_sm1_48_us_h2d[1] = tl_s1n_54_ds_h2d[15];
  assign tl_s1n_54_ds_d2h[15] = tl_sm1_48_us_d2h[1];

  assign tl_sm1_49_us_h2d[1] = tl_s1n_54_ds_h2d[16];
  assign tl_s1n_54_ds_d2h[16] = tl_sm1_49_us_d2h[1];

  assign tl_sm1_50_us_h2d[1] = tl_s1n_54_ds_h2d[17];
  assign tl_s1n_54_ds_d2h[17] = tl_sm1_50_us_d2h[1];

  assign tl_sm1_53_us_h2d[1] = tl_s1n_54_ds_h2d[18];
  assign tl_s1n_54_ds_d2h[18] = tl_sm1_53_us_d2h[1];

  assign tl_sm1_52_us_h2d[1] = tl_s1n_54_ds_h2d[19];
  assign tl_s1n_54_ds_d2h[19] = tl_sm1_52_us_d2h[1];

  assign tl_sm1_32_us_h2d[2] = tl_s1n_54_ds_h2d[20];
  assign tl_s1n_54_ds_d2h[20] = tl_sm1_32_us_d2h[2];
  ...
  assign tl_rv_dm__rom_o = tl_sm1_31_ds_h2d;
  assign tl_sm1_31_ds_d2h = tl_rv_dm__rom_i;
  ...
  tlul_socket_1n #(
    .HReqDepth (4'h0),
    .HRspDepth (4'h0),
    .DReqPass  (25'h1ffffc7),
    .DRspPass  (25'h1ffffc7),
    .DReqDepth (100'h222000),
    .DRspDepth (100'h222000),
    .N         (25)
  ) u_s1n_34 (
    .clk_i        (clk_main_i),
    .rst_ni       (rst_main_ni),
