...
module xbar_main (
  ...
  tl_h2d_t tl_s1n_52_ds_h2d [21];
  tl_d2h_t tl_s1n_52_ds_d2h [21];
  ...
  assign tl_sim_ctrl_o = tl_s1n_32_ds_h2d[3];
  assign tl_s1n_32_ds_d2h[3] = tl_sim_ctrl_i;

  assign tl_alsaqr_o = tl_s1n_32_ds_h2d[4];
  assign tl_s1n_32_ds_d2h[4] = tl_alsaqr_i;

  assign tl_sm1_34_us_h2d[0] = tl_s1n_32_ds_h2d[5];
  assign tl_s1n_32_ds_d2h[5] = tl_sm1_34_us_d2h[0];

  assign tl_sm1_30_us_h2d[1] = tl_s1n_32_ds_h2d[6];
  assign tl_s1n_32_ds_d2h[6] = tl_sm1_30_us_d2h[1];

  assign tl_sm1_36_us_h2d[0] = tl_s1n_32_ds_h2d[7];
  assign tl_s1n_32_ds_d2h[7] = tl_sm1_36_us_d2h[0];

  assign tl_sm1_37_us_h2d[0] = tl_s1n_32_ds_h2d[8];
  assign tl_s1n_32_ds_d2h[8] = tl_sm1_37_us_d2h[0];

  assign tl_sm1_38_us_h2d[0] = tl_s1n_32_ds_h2d[9];
  assign tl_s1n_32_ds_d2h[9] = tl_sm1_38_us_d2h[0];

  assign tl_sm1_39_us_h2d[0] = tl_s1n_32_ds_h2d[10];
  assign tl_s1n_32_ds_d2h[10] = tl_sm1_39_us_d2h[0];

  assign tl_sm1_31_us_h2d[1] = tl_s1n_32_ds_h2d[11];
  assign tl_s1n_32_ds_d2h[11] = tl_sm1_31_us_d2h[1];

  assign tl_sm1_40_us_h2d[0] = tl_s1n_32_ds_h2d[12];
  assign tl_s1n_32_ds_d2h[12] = tl_sm1_40_us_d2h[0];

  assign tl_sm1_41_us_h2d[0] = tl_s1n_32_ds_h2d[13];
  assign tl_s1n_32_ds_d2h[13] = tl_sm1_41_us_d2h[0];

  assign tl_sm1_42_us_h2d[0] = tl_s1n_32_ds_h2d[14];
  assign tl_s1n_32_ds_d2h[14] = tl_sm1_42_us_d2h[0];

  assign tl_sm1_43_us_h2d[0] = tl_s1n_32_ds_h2d[15];
  assign tl_s1n_32_ds_d2h[15] = tl_sm1_43_us_d2h[0];

  assign tl_sm1_44_us_h2d[0] = tl_s1n_32_ds_h2d[16];
  assign tl_s1n_32_ds_d2h[16] = tl_sm1_44_us_d2h[0];

  assign tl_sm1_45_us_h2d[0] = tl_s1n_32_ds_h2d[17];
  assign tl_s1n_32_ds_d2h[17] = tl_sm1_45_us_d2h[0];

  assign tl_sm1_46_us_h2d[0] = tl_s1n_32_ds_h2d[18];
  assign tl_s1n_32_ds_d2h[18] = tl_sm1_46_us_d2h[0];

  assign tl_sm1_47_us_h2d[0] = tl_s1n_32_ds_h2d[19];
  assign tl_s1n_32_ds_d2h[19] = tl_sm1_47_us_d2h[0];

  assign tl_sm1_48_us_h2d[0] = tl_s1n_32_ds_h2d[20];
  assign tl_s1n_32_ds_d2h[20] = tl_sm1_48_us_d2h[0];

  assign tl_sm1_49_us_h2d[0] = tl_s1n_32_ds_h2d[21];
  assign tl_s1n_32_ds_d2h[21] = tl_sm1_49_us_d2h[0];

  assign tl_sm1_50_us_h2d[0] = tl_s1n_32_ds_h2d[22];
  assign tl_s1n_32_ds_d2h[22] = tl_sm1_50_us_d2h[0];

  assign tl_sm1_51_us_h2d[0] = tl_s1n_32_ds_h2d[23];
  assign tl_s1n_32_ds_d2h[23] = tl_sm1_51_us_d2h[0];

  assign tl_sm1_34_us_h2d[1] = tl_s1n_52_ds_h2d[0];
  assign tl_s1n_52_ds_d2h[0] = tl_sm1_34_us_d2h[1];

  assign tl_sm1_28_us_h2d[2] = tl_s1n_52_ds_h2d[1];
  assign tl_s1n_52_ds_d2h[1] = tl_sm1_28_us_d2h[2];

  assign tl_sm1_33_us_h2d[1] = tl_s1n_52_ds_h2d[2];
  assign tl_s1n_52_ds_d2h[2] = tl_sm1_33_us_d2h[1];

  assign tl_sm1_36_us_h2d[1] = tl_s1n_52_ds_h2d[3];
  assign tl_s1n_52_ds_d2h[3] = tl_sm1_36_us_d2h[1];

  assign tl_sm1_37_us_h2d[1] = tl_s1n_52_ds_h2d[4];
  assign tl_s1n_52_ds_d2h[4] = tl_sm1_37_us_d2h[1];
  ...
  assign tl_sm1_31_us_h2d[2] = tl_s1n_52_ds_h2d[7];
  assign tl_s1n_52_ds_d2h[7] = tl_sm1_31_us_d2h[2];

  assign tl_sm1_45_us_h2d[1] = tl_s1n_52_ds_h2d[8];
  assign tl_s1n_52_ds_d2h[8] = tl_sm1_45_us_d2h[1];

  assign tl_sm1_49_us_h2d[1] = tl_s1n_52_ds_h2d[9];
  assign tl_s1n_52_ds_d2h[9] = tl_sm1_49_us_d2h[1];

  assign tl_sm1_40_us_h2d[1] = tl_s1n_52_ds_h2d[10];
  assign tl_s1n_52_ds_d2h[10] = tl_sm1_40_us_d2h[1];

  assign tl_sm1_41_us_h2d[1] = tl_s1n_52_ds_h2d[11];
  assign tl_s1n_52_ds_d2h[11] = tl_sm1_41_us_d2h[1];

  assign tl_sm1_42_us_h2d[1] = tl_s1n_52_ds_h2d[12];
  assign tl_s1n_52_ds_d2h[12] = tl_sm1_42_us_d2h[1];

  assign tl_sm1_43_us_h2d[1] = tl_s1n_52_ds_h2d[13];
  assign tl_s1n_52_ds_d2h[13] = tl_sm1_43_us_d2h[1];

  assign tl_sm1_44_us_h2d[1] = tl_s1n_52_ds_h2d[14];
  assign tl_s1n_52_ds_d2h[14] = tl_sm1_44_us_d2h[1];

  assign tl_sm1_46_us_h2d[1] = tl_s1n_52_ds_h2d[15];
  assign tl_s1n_52_ds_d2h[15] = tl_sm1_46_us_d2h[1];

  assign tl_sm1_47_us_h2d[1] = tl_s1n_52_ds_h2d[16];
  assign tl_s1n_52_ds_d2h[16] = tl_sm1_47_us_d2h[1];

  assign tl_sm1_48_us_h2d[1] = tl_s1n_52_ds_h2d[17];
  assign tl_s1n_52_ds_d2h[17] = tl_sm1_48_us_d2h[1];

  assign tl_sm1_51_us_h2d[1] = tl_s1n_52_ds_h2d[18];
  assign tl_s1n_52_ds_d2h[18] = tl_sm1_51_us_d2h[1];

  assign tl_sm1_50_us_h2d[1] = tl_s1n_52_ds_h2d[19];
  assign tl_s1n_52_ds_d2h[19] = tl_sm1_50_us_d2h[1];

  assign tl_sm1_30_us_h2d[2] = tl_s1n_52_ds_h2d[20];
  assign tl_s1n_52_ds_d2h[20] = tl_sm1_30_us_d2h[2];
  ...
  assign tl_spi_host0_o = tl_sm1_37_ds_h2d;
  assign tl_sm1_37_ds_d2h = tl_spi_host0_i;
