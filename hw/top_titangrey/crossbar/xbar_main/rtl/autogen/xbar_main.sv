...
module xbar_main (
  ...
  output tlul_pkg::tl_h2d_t tl_alsaqr_o,
  input  tlul_pkg::tl_d2h_t tl_alsaqr_i,
  ...
  output tlul_pkg::tl_h2d_t tl_ram_2p_o,
  input  tlul_pkg::tl_d2h_t tl_ram_2p_i,
  ...
  tl_h2d_t tl_s1n_55_ds_h2d [21];
  tl_d2h_t tl_s1n_55_ds_d2h [21];

  // Create steering signal
  logic [4:0] dev_sel_s1n_55;
  ...
  assign tl_instr_mem_o = tl_s1n_30_ds_h2d[4];
  assign tl_s1n_30_ds_d2h[4] = tl_instr_mem_i;
  ...
  assign tl_sim_ctrl_o = tl_s1n_35_ds_h2d[3];
  assign tl_s1n_35_ds_d2h[3] = tl_sim_ctrl_i;

  assign tl_ram_2p_o = tl_s1n_35_ds_h2d[4];
  assign tl_s1n_35_ds_d2h[4] = tl_ram_2p_i;

  assign tl_alsaqr_o = tl_s1n_35_ds_h2d[5];
  assign tl_s1n_35_ds_d2h[5] = tl_alsaqr_i;

  assign tl_mailbox_o = tl_s1n_35_ds_h2d[6];
  assign tl_s1n_35_ds_d2h[6] = tl_mailbox_i;

  assign tl_sm1_37_us_h2d[0] = tl_s1n_35_ds_h2d[7];
  assign tl_s1n_35_ds_d2h[7] = tl_sm1_37_us_d2h[0];

  assign tl_sm1_33_us_h2d[1] = tl_s1n_35_ds_h2d[8];
  assign tl_s1n_35_ds_d2h[8] = tl_sm1_33_us_d2h[1];

  assign tl_sm1_39_us_h2d[0] = tl_s1n_35_ds_h2d[9];
  assign tl_s1n_35_ds_d2h[9] = tl_sm1_39_us_d2h[0];

  assign tl_sm1_40_us_h2d[0] = tl_s1n_35_ds_h2d[10];
  assign tl_s1n_35_ds_d2h[10] = tl_sm1_40_us_d2h[0];

  assign tl_sm1_41_us_h2d[0] = tl_s1n_35_ds_h2d[11];
  assign tl_s1n_35_ds_d2h[11] = tl_sm1_41_us_d2h[0];

  assign tl_sm1_42_us_h2d[0] = tl_s1n_35_ds_h2d[12];
  assign tl_s1n_35_ds_d2h[12] = tl_sm1_42_us_d2h[0];

  assign tl_sm1_34_us_h2d[1] = tl_s1n_35_ds_h2d[13];
  assign tl_s1n_35_ds_d2h[13] = tl_sm1_34_us_d2h[1];

  assign tl_sm1_43_us_h2d[0] = tl_s1n_35_ds_h2d[14];
  assign tl_s1n_35_ds_d2h[14] = tl_sm1_43_us_d2h[0];

  assign tl_sm1_44_us_h2d[0] = tl_s1n_35_ds_h2d[15];
  assign tl_s1n_35_ds_d2h[15] = tl_sm1_44_us_d2h[0];

  assign tl_sm1_45_us_h2d[0] = tl_s1n_35_ds_h2d[16];
  assign tl_s1n_35_ds_d2h[16] = tl_sm1_45_us_d2h[0];

  assign tl_sm1_46_us_h2d[0] = tl_s1n_35_ds_h2d[17];
  assign tl_s1n_35_ds_d2h[17] = tl_sm1_46_us_d2h[0];

  assign tl_sm1_47_us_h2d[0] = tl_s1n_35_ds_h2d[18];
  assign tl_s1n_35_ds_d2h[18] = tl_sm1_47_us_d2h[0];

  assign tl_sm1_48_us_h2d[0] = tl_s1n_35_ds_h2d[19];
  assign tl_s1n_35_ds_d2h[19] = tl_sm1_48_us_d2h[0];

  assign tl_sm1_49_us_h2d[0] = tl_s1n_35_ds_h2d[20];
  assign tl_s1n_35_ds_d2h[20] = tl_sm1_49_us_d2h[0];

  assign tl_sm1_50_us_h2d[0] = tl_s1n_35_ds_h2d[21];
  assign tl_s1n_35_ds_d2h[21] = tl_sm1_50_us_d2h[0];

  assign tl_sm1_51_us_h2d[0] = tl_s1n_35_ds_h2d[22];
  assign tl_s1n_35_ds_d2h[22] = tl_sm1_51_us_d2h[0];

  assign tl_sm1_52_us_h2d[0] = tl_s1n_35_ds_h2d[23];
  assign tl_s1n_35_ds_d2h[23] = tl_sm1_52_us_d2h[0];

  assign tl_sm1_53_us_h2d[0] = tl_s1n_35_ds_h2d[24];
  assign tl_s1n_35_ds_d2h[24] = tl_sm1_53_us_d2h[0];

  assign tl_sm1_54_us_h2d[0] = tl_s1n_35_ds_h2d[25];
  assign tl_s1n_35_ds_d2h[25] = tl_sm1_54_us_d2h[0];

  assign tl_sm1_37_us_h2d[1] = tl_s1n_55_ds_h2d[0];
  assign tl_s1n_55_ds_d2h[0] = tl_sm1_37_us_d2h[1];

  assign tl_sm1_31_us_h2d[2] = tl_s1n_55_ds_h2d[1];
  assign tl_s1n_55_ds_d2h[1] = tl_sm1_31_us_d2h[2];

  assign tl_sm1_36_us_h2d[1] = tl_s1n_55_ds_h2d[2];
  assign tl_s1n_55_ds_d2h[2] = tl_sm1_36_us_d2h[1];

  assign tl_sm1_39_us_h2d[1] = tl_s1n_55_ds_h2d[3];
  assign tl_s1n_55_ds_d2h[3] = tl_sm1_39_us_d2h[1];

  assign tl_sm1_40_us_h2d[1] = tl_s1n_55_ds_h2d[4];
  assign tl_s1n_55_ds_d2h[4] = tl_sm1_40_us_d2h[1];

  assign tl_sm1_41_us_h2d[1] = tl_s1n_55_ds_h2d[5];
  assign tl_s1n_55_ds_d2h[5] = tl_sm1_41_us_d2h[1];

  assign tl_sm1_42_us_h2d[1] = tl_s1n_55_ds_h2d[6];
  assign tl_s1n_55_ds_d2h[6] = tl_sm1_42_us_d2h[1];

  assign tl_sm1_34_us_h2d[2] = tl_s1n_55_ds_h2d[7];
  assign tl_s1n_55_ds_d2h[7] = tl_sm1_34_us_d2h[2];

  assign tl_sm1_48_us_h2d[1] = tl_s1n_55_ds_h2d[8];
  assign tl_s1n_55_ds_d2h[8] = tl_sm1_48_us_d2h[1];

  assign tl_sm1_52_us_h2d[1] = tl_s1n_55_ds_h2d[9];
  assign tl_s1n_55_ds_d2h[9] = tl_sm1_52_us_d2h[1];

  assign tl_sm1_43_us_h2d[1] = tl_s1n_55_ds_h2d[10];
  assign tl_s1n_55_ds_d2h[10] = tl_sm1_43_us_d2h[1];

  assign tl_sm1_44_us_h2d[1] = tl_s1n_55_ds_h2d[11];
  assign tl_s1n_55_ds_d2h[11] = tl_sm1_44_us_d2h[1];

  assign tl_sm1_45_us_h2d[1] = tl_s1n_55_ds_h2d[12];
  assign tl_s1n_55_ds_d2h[12] = tl_sm1_45_us_d2h[1];

  assign tl_sm1_46_us_h2d[1] = tl_s1n_55_ds_h2d[13];
  assign tl_s1n_55_ds_d2h[13] = tl_sm1_46_us_d2h[1];

  assign tl_sm1_47_us_h2d[1] = tl_s1n_55_ds_h2d[14];
  assign tl_s1n_55_ds_d2h[14] = tl_sm1_47_us_d2h[1];

  assign tl_sm1_49_us_h2d[1] = tl_s1n_55_ds_h2d[15];
  assign tl_s1n_55_ds_d2h[15] = tl_sm1_49_us_d2h[1];

  assign tl_sm1_50_us_h2d[1] = tl_s1n_55_ds_h2d[16];
  assign tl_s1n_55_ds_d2h[16] = tl_sm1_50_us_d2h[1];

  assign tl_sm1_51_us_h2d[1] = tl_s1n_55_ds_h2d[17];
  assign tl_s1n_55_ds_d2h[17] = tl_sm1_51_us_d2h[1];

  assign tl_sm1_54_us_h2d[1] = tl_s1n_55_ds_h2d[18];
  assign tl_s1n_55_ds_d2h[18] = tl_sm1_54_us_d2h[1];

  assign tl_sm1_53_us_h2d[1] = tl_s1n_55_ds_h2d[19];
  assign tl_s1n_55_ds_d2h[19] = tl_sm1_53_us_d2h[1];

  assign tl_sm1_33_us_h2d[2] = tl_s1n_55_ds_h2d[20];
  assign tl_s1n_55_ds_d2h[20] = tl_sm1_33_us_d2h[2];
  ...
  assign tl_rv_dm__rom_o = tl_sm1_32_ds_h2d;
  assign tl_sm1_32_ds_d2h = tl_rv_dm__rom_i;
  ...
  assign tl_sram_ctrl_main__regs_o = tl_sm1_53_ds_h2d;
  assign tl_sm1_53_ds_d2h = tl_sram_ctrl_main__regs_i;

  assign tl_rv_core_ibex__cfg_o = tl_sm1_54_ds_h2d;
  assign tl_sm1_54_ds_d2h = tl_rv_core_ibex__cfg_i;

  assign tl_s1n_55_us_h2d = tl_rv_dm__sba_i;
  assign tl_rv_dm__sba_o = tl_s1n_55_us_d2h;
  ...
  always_comb begin
    ...
    if ((tl_s1n_30_us_h2d.a_address &
      ...
      dev_sel_s1n_30 = 3'd3;
                  ...
                  ~(ADDR_MASK_INSTR_MEM)) == ADDR_SPACE_INSTR_MEM) begin
      dev_sel_s1n_30 = 3'd4;
end
  end
  ...
  always_comb begin
    ...
    if ((tl_s1n_35_us_h2d.a_address &
      ...
      dev_sel_s1n_35 = 5'd3;
                  ...
                  ~(ADDR_MASK_RAM_2P)) == ADDR_SPACE_RAM_2P) begin
      dev_sel_s1n_35 = 5'd4;
  ...
  always_comb begin
    ...
    if ((tl_s1n_55_us_h2d.a_address &
      ...
      dev_sel_s1n_55 = 5'd9;
                  ...
                  ~(ADDR_MASK_AES)) == ADDR_SPACE_AES) begin
      dev_sel_s1n_55 = 5'd10;

    end else if ((tl_s1n_55_us_h2d.a_address &
                  ~(ADDR_MASK_ENTROPY_SRC)) == ADDR_SPACE_ENTROPY_SRC) begin
      dev_sel_s1n_55 = 5'd11;

    end else if ((tl_s1n_55_us_h2d.a_address &
                  ~(ADDR_MASK_CSRNG)) == ADDR_SPACE_CSRNG) begin
      dev_sel_s1n_55 = 5'd12;

    end else if ((tl_s1n_55_us_h2d.a_address &
                  ~(ADDR_MASK_EDN0)) == ADDR_SPACE_EDN0) begin
      dev_sel_s1n_55 = 5'd13;

    end else if ((tl_s1n_55_us_h2d.a_address &
                  ~(ADDR_MASK_EDN1)) == ADDR_SPACE_EDN1) begin
      dev_sel_s1n_55 = 5'd14;

    end else if ((tl_s1n_55_us_h2d.a_address &
                  ~(ADDR_MASK_RV_PLIC)) == ADDR_SPACE_RV_PLIC) begin
      dev_sel_s1n_55 = 5'd15;

    end else if ((tl_s1n_55_us_h2d.a_address &
                  ~(ADDR_MASK_OTBN)) == ADDR_SPACE_OTBN) begin
      dev_sel_s1n_55 = 5'd16;

    end else if ((tl_s1n_55_us_h2d.a_address &
                  ~(ADDR_MASK_KEYMGR)) == ADDR_SPACE_KEYMGR) begin
      dev_sel_s1n_55 = 5'd17;

    end else if ((tl_s1n_55_us_h2d.a_address &
                  ~(ADDR_MASK_RV_CORE_IBEX__CFG)) == ADDR_SPACE_RV_CORE_IBEX__CFG) begin
      dev_sel_s1n_55 = 5'd18;

    end else if ((tl_s1n_55_us_h2d.a_address &
                  ~(ADDR_MASK_SRAM_CTRL_MAIN__REGS)) == ADDR_SPACE_SRAM_CTRL_MAIN__REGS) begin
      dev_sel_s1n_55 = 5'd19;

    end else if ((tl_s1n_55_us_h2d.a_address &
                  ~(ADDR_MASK_SRAM_CTRL_MAIN__RAM)) == ADDR_SPACE_SRAM_CTRL_MAIN__RAM) begin
      dev_sel_s1n_55 = 5'd20;
end
  end
  ...
  tlul_socket_1n #(
    .HReqDepth (4'h0),
    .HRspDepth (4'h0),
    .DReqPass  (26'h3ffff87),
    .DRspPass  (26'h3ffff87),
    .DReqDepth (104'h2222000),
    .DRspDepth (104'h2222000),
    .N         (26)
  ) u_s1n_35 (
    .clk_i        (clk_main_i),
    .rst_ni       (rst_main_ni),
