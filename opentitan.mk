...
sim_gls_run:
	$(MAKE) -C target/gf22/questasim sim_gls_run
...
common_targs += -t test
common_targs += -t test_ot_vip
common_targs += -t tech_sim
common_targs += -t simulation
# Define #
...
scripts/compile_opentitan.tcl: Bender.yml
	$(BENDER) script $(VSIM) --vlog-arg="$(VLOG_ARGS)" $(common_defs) $(common_targs) > $@
...
init: update generate_idma_rtl scripts/compile_opentitan.tcl $(OT_ROOT)/hw/tb/vips
